  ...
  Foundation.libs.tooltip = {
    ...
    events : function () {
      ...
      /*if (Modernizr.touch) {
        ...
        $(this.scope)
          .off('.tooltip')
          .on('mouseenter.fndtn.tooltip', 
            '[data-tooltip]', function (e) {
            var $this = $(this);
            console.log($this.data('clicked_open'))
if (!$this.data('clicked_open')) {
$this.data('hovered_open', true);
              self.showOrCreateTip($this);
				//$this.data('clicked_open', false);
			}
          })
          .on('mouseleave.fndtn.tooltip', 
            '[data-tooltip]', function (e) {
            var $this = $(this);
            if ($this.data('hovered_open')){
              self.hide($this);
		              }
$this.data('hovered_open', false);
          })
          .on('click.fndtn.tooltip touchstart.fndtn.tooltip touchend.fndtn.tooltip', 
            '[data-tooltip]', function (e) {
            var settings = $.extend({}, self.settings, self.data_options($(this)));
...
$(this).data('hovered_open', false);
          ...
          .on('click.fndtn.tooltip touchstart.fndtn.tooltip touchend.fndtn.tooltip', 
            this.settings.tooltip_class, function (e) {
            e.preventDefault();
$('[data-selector="' + $(this).attr('data-selector') + '"][data-tooltip]').data('clicked_open', false);
            console.log($('[data-selector="' + $(this).attr('data-selector') + '"][data-tooltip]').data('clicked_open'))
            $(this).fadeOut(150);
          });
      //}
    },
    ...
    showOrCreateTip : function ($target) {
      ...
      if ($target.data('clicked_open')) {
        this.getTip($target).find('.tap-to-close').show();
      }
      else {
      	this.getTip($target).find('.tap-to-close').hide();
      }
    },
